...
> 📸 **Место для скриншотов установки расширения**
>
> * Режим разработчика (рис. 41)
![](./images/ris51.png)
![Режим разработчика](./images/ris51.png)
> * Загрузка распакованного расширения (рис. 42)
...
> 📸 **Место для скриншотов изменения конфигурации**
>
> * config.go (рис. 43)
> * index.html (рис. 44)
> * background.js (рис. 45)
...
> 📸 **Место для скриншотов установки Go**
>
> * Распаковка архива (рис. 46)
> * Добавление PATH (рис. 47)
> * Применение изменений (рис. 48)
...
> 📸 **Место для скриншота результата сборки**
>
> * Скомпилированный бинарный файл (рис. 49)
...
> 📸 **Место для скриншота отображения вредоносного QR**
>
> * Интерфейс с QR-кодом (рис. 50)
